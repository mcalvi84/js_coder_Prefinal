...
const ingresarDatos = () => {
    ...
    producto === null ? producto ='SIN NOMBRE' : producto = producto.toUpperCase(); 
    
    let cantidad = prompt('Ingrese cantidad de Productos.'); 
    cantidad === null ? cantidad ='SIN CANTIDAD' : cantidad = cantidad.toUpperCase(); 
